...
import hackerrankjavaproblems.graphtheory.roadsandlibraries.RoadsAndLibraries_Main_V1;
import static hackerrankjavaproblems.graphtheory.roadsandlibraries.RoadsAndLibraries_Main_V1.getLowestCost;
import java.io.File;
 ...
 */
public class JourneyToTheMoon_Main_V1 {
    ...
    public static void testGetAllCombinations()
    {
        ...
        System.out.println(getAllCombinationsWithGivenNumberOfItems(arr, 3));
    }
    ...
    public static void test_JourneyToTheMoon_readFromFile(){
        try {
            File file = new File("src/hackerrankjavaproblems/graphtheory/journeytothemoon/input11.txt");
    ...
    public static long getNumCombinations(int numAstros, Collection<Pair> pairs)
    {
        ...
        System.out.println(setSizesMappedToCounts);
        System.out.println(uniqueSetSizes);
